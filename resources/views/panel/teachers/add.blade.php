        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{route('teachers_add_do')}}" method="post" enctype="multipart/form-data">
              	@csrf
                <div class="card-body">
                   @if($errors->any())
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" required="" name="name" id="exampleInputEmail1" placeholder="Enter Student Name">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Basic Salary*</label>
                    <input type="text" class="form-control" required="" name="basic_salary" id="exampleInputEmail1" placeholder="Enter Student Name">
                  </div>
